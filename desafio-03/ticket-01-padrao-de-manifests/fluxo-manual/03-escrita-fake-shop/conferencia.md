...
Trivy: executado · BARRA: 0 · JUSTIFICAR: 0 · OK: 18 · NAO_VERIFICADO: 0 · NAO_SE_APLICA: 0
...
| 1.5 Anotacao metacortex.io/owner | recomendado | script | OK |
...
- [ ] 3.2 Job/orion-web-migracao-v1 (orion-web-migracao.yaml): readOnlyRootFilesystem ligado; conferir no projeto todo caminho em que a aplicacao escreve e se ha emptyDir montado nele.
- [ ] 2.2 Deployment/orion-web (orion-web.yaml) 'web': confirmar no codigo que readiness=/shop e liveness=/metrics existem, na porta certa, e que a liveness nao depende do banco.
- [ ] 2.1 Deployment/orion-web (orion-web.yaml) 'web': limits de memoria devem ficar entre 1,5x e 2x o consumo observado; o YAML nao diz o consumo.
- [ ] 3.2 Deployment/orion-web (orion-web.yaml): readOnlyRootFilesystem ligado; conferir no projeto todo caminho em que a aplicacao escreve e se ha emptyDir montado nele.
- [ ] 2.6 Deployment/orion-web (orion-web.yaml): conferir no projeto se a aplicacao trata SIGTERM e se 30s bastam para drenar.
